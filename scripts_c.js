...
var destinationMarker = new mapboxgl.Marker({ color: '#ff0000' }) // เลือกสีส้มสำหรับเครื่องหมาย
  .setLngLat([99.82696718806311, 19.90341840883823])
  .addTo(map);
...
if ("geolocation" in navigator) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    destinationMarker.setLngLat([99.82696718806311, 19.90341840883823]);


    var directionsAPI = 'https://api.mapbox.com/directions/v5/mapbox/driving/' + lng + ',' + lat + ';' + '99.82696718806311' + ',' + '19.90341840883823' + '?steps=true&geometries=geojson&access_token=' + mapboxgl.accessToken;
    fetch(directionsAPI)
